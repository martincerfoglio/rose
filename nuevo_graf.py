...
def graficar_alerta(alerta, segundos_despues=30):
    ...
    ruta_csv = f'C:\\Users\\marti\\rose\\csvs\\rose\\{crypto}USDT-trades-{timestamp_alerta[0:10]}.csv'
    ...
    # escala_ampliada = 0.1  # Puedes ajustar este valor según tus necesidades
